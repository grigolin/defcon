...
@WebServlet(name = "CarregarConsumidor", urlPatterns = {"/CarregarConsumidor"})
public class CarregarConsumidor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                request.setAttribute("consumidor", dao.carregar(idPessoa));
                request.getRequestDispatcher("alterarConsumidor.jsp").forward(request, response);
            } catch (Exception e) {
