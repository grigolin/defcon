...
@WebServlet(name = "CarregarAdvogado", urlPatterns = {"/CarregarAdvogado"})
public class CarregarAdvogado extends HttpServlet {
    ...
    if (sessao.getAttribute("sessaoP") != null) {
            ...
            try{  
                ...
                request.setAttribute("advogado", dao.carregar(idPessoa));
                request.getRequestDispatcher("alterarAdvogado.jsp").forward(request, response);
            }catch(Exception e){
