...
@WebServlet(name = "CadastrarPostagemAdvogado", urlPatterns = {"/CadastrarPostagemAdvogado"})
public class CadastrarPostagemAdvogado extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                request.getRequestDispatcher("ListarPostagemAdvogado").forward(request, response);
            } catch (Exception ex) {
