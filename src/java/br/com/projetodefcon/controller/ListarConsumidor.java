...
@WebServlet(name = "ListarConsumidor", urlPatterns = {"/ListarConsumidor"})
public class ListarConsumidor extends HttpServlet {
    ...
    if (sessao.getAttribute("sessaoP") != null) {
                try {
                    ...
                    request.setAttribute("consumidores", dao.listar());
                    request.getRequestDispatcher("advogados.jsp").forward(request, response);
                } catch (Exception e) {
