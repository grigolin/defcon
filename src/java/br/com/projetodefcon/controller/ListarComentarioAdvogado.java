...
@WebServlet(name = "ListarComentarioAdvogado", urlPatterns = {"/ListarComentarioAdvogado"})
public class ListarComentarioAdvogado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                request.getRequestDispatcher("comentariosPostagemAdvogado.jsp").forward(request, response);
            } catch(Exception e){
